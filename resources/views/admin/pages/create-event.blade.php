  ...
  <div class="row">
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            {{Form::open(array('url'=>'admin/events/create','method'=>'post'))}}
              <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea name="description" class="form-control textarea" placeholder="We are meeting with scholars in Kathmandu at INF office, Jawalakhel." style="width: 100%; height: 110px; line-height: 18px; border: 1px solid #dddddd; padding: 10px">{{null !==(Input::old('description'))?Input::old('description'):''}}</textarea>
                       </div>
                  </div>
                </div>
