...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
     <div class="col-md-8">
        <h4><strong>Add New Church</strong></h4>
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            {{Form::open(array('url'=>'admin/churches/create','method'=>'post'))}}
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <textarea name="description" class="form-control textarea" placeholder="Place some text here" style="width: 100%; height: 80px; line-height: 18px; border: 1px solid #dddddd; padding: 10px">{{null !==(Input::old('description'))?Input::old('description'):''}}</textarea>
                       </div>
                  </div>
