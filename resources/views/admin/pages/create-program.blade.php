...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
     <div class="col-md-8">
        <h4><strong>Add New Program</strong></h4>
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            {{Form::open(array('url'=>'admin/programs/create','method'=>'post','enctype' => 'multipart/form-data'))}}
              <div class="box-body">
                    ...
                    <div class="col-md-12">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="description" id="compose-textarea" class="form-control textarea" placeholder="Program details" style="width: 100%; height: 300px; line-height: 18px; border: 1px solid #dddddd; padding: 10px">{{null !==(Input::old('description'))?Input::old('description'):''}}</textarea>
                         </div>
