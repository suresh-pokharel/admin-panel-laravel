...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
     <div class="col-md-8">
        <h4><strong>Add New Scholar</strong></h4>
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            {{Form::open(array('url'=>'admin/scholars/create','method'=>'post','enctype' => 'multipart/form-data'))}}
              <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <p class="help-block">190X120 px image less than 2MB</p>
                          </div>
                          <div class="checkbox">
                            <label>
